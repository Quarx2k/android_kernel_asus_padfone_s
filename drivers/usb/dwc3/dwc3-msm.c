						...
						unsigned event_status)
{
	...
	if (override_phy_init) {
		...
		/* ASUS_BSP+++ MoudyHo "[PF500KL][USBH][NA][Spec] Adjust eye diagram parameter for device electrical test fail */
		//mdwc->hsphy_init_seq = 0xd194e4;
		mdwc->hsphy_init_seq = 0xd8d4e4;
		/* ASUS_BSP--- MoudyHo "[PF500KL][USBH][NA][Spec] Adjust eye diagram parameter for device electrical test fail */
...
//ASUS_BSP--- BennyCheng "add phone mode usb OTG support"
	...
	usbdev_nb.notifier_call = msm_otg_usbdev_notify;
