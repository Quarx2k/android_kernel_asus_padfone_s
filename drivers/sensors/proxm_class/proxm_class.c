...
//........................................................................................//
	...
	if (master_input_dev != NULL)	{
		als_timestamp = ktime_get_boottime();
		input_report_abs(master_input_dev, ABS_MISC, lux);
		input_event(master_input_dev, EV_SYN, SYN_REPORT, 1);
		input_event(master_input_dev, EV_SYN, SYN_TIME_SEC, ktime_to_timespec(als_timestamp).tv_sec);
		input_event(master_input_dev, EV_SYN, SYN_TIME_NSEC, ktime_to_timespec(als_timestamp).tv_nsec);
		input_sync(master_input_dev);
	}
	else
