...
#define DEFAULT_DEVICE_RESISTOR_VALUE_A91_SR 157
#define DEFAULT_DEVICE_RESISTOR_VALUE_A91_ER 100
...
#ifdef CONFIG_PM_8941_CHARGER
int A91_SR_SrcOCVtoPerTbl[OCV_TBL_SIZE]={
	3400, 3475, 3535, 3590, 3638, 3670, 3679, 3681, 3683, 3685, 
	3687, 3689, 3695, 3703, 3710, 3718, 3727, 3733, 3737, 3741, 
	3745, 3750, 3753, 3757, 3758, 3761, 3763, 3766, 3769, 3771, 
	3773, 3774, 3777, 3779, 3781, 3784, 3786, 3789, 3792, 3794,
	3797, 3801, 3803, 3807, 3812, 3815, 3818, 3823, 3828, 3832, 

	3837, 3843, 3849, 3857, 3867, 3879, 3890, 3899, 3909, 3915, 
	3923, 3930, 3937, 3944, 3952, 3958, 3962, 3964, 3971, 3978, 
	3988, 3999, 4014, 4029, 4045, 4056, 4060, 4067, 4075, 4085, 
	4095, 4106, 4116, 4127, 4137, 4148, 4158, 4170, 4180, 4191, 
	4199, 4206, 4214, 4222, 4230, 4239, 4248, 4256, 4266, 4278, 
	4301
};

//Abby A91 Battery 20131129 version +++
int A91_ER_SrcOCVtoPerTbl[OCV_TBL_SIZE]={
	3456, 3540, 3601, 3645, 3665, 3672, 3675, 3677, 3678, 3679, 
	3681, 3683, 3691, 3699, 3706, 3712, 3719, 3724, 3729, 3734, 
	3737, 3740, 3744, 3747, 3750, 3752, 3755, 3757, 3759, 3762, 
	3765, 3766, 3768, 3771, 3773, 3776, 3779, 3782, 3784, 3788,
	3791, 3794, 3798, 3800, 3802, 3806, 3811, 3815, 3819, 3823, 

	3828, 3833, 3838, 3843, 3849, 3857, 3864, 3875, 3885, 3895, 
	3905, 3913, 3920, 3930, 3936, 3943, 3950, 3957, 3963, 3969, 
	3973, 3979, 3988, 4000, 4015, 4030, 4043, 4049, 4055, 4064, 
	4073, 4084, 4094, 4104, 4115, 4125, 4136, 4145, 4157, 4166, 
	4176, 4187, 4199, 4210, 4221, 4233, 4244, 4256, 4270, 4284, 
	4296
};
//Abby A91 Battery 20131129 version ---
#endif
...
//ASUS_BSP Eason read battery ID+++  
#ifdef CONFIG_PM_8941_CHARGER
		  this->resistorCali = DEFAULT_DEVICE_RESISTOR_VALUE_A91_ER;
#else
...
//ASUS_BSP Eason read battery ID+++    
#ifdef CONFIG_PM_8941_CHARGER
		  resistor = DEFAULT_DEVICE_RESISTOR_VALUE_A91_ER;
#else
    if(g_BatteryID_value<1100000)
    {
...
{
#ifdef CONFIG_PM_8941_CHARGER
	int Vf300TableSec[20] = {50,50,50,52,54,54,48,40,37,37,39,38,35,36,37,37,34,35,36,35};
...
{
#ifdef CONFIG_PM_8941_CHARGER
	int Vf900TableSec[20] = {140,140,135,122,117,114,109,104,99,99,98,111,116,106,104,105,106,104,101,101};
							//3447 to 4340	interval:47 mV, total:20
#else
...
#ifdef CONFIG_PM_8941_CHARGER
	if( (curr < -100) && (1==getIfonline()) && (false==pm8941_is_full()) )
#else
...
#ifdef CONFIG_PM_8941_CHARGER  
        else if((true == WhenBootUpDoVf) && (curr < -100) && (false==pm8941_is_full()))//Eason: Do VF with Cable when boot up+++
#else
...
//ASUS_BSP Eason read battery ID+++
#ifdef CONFIG_PM_8941_CHARGER
	CurrOCVtoPerTbl = A91_ER_SrcOCVtoPerTbl;
#else
    if(g_BatteryID_value<1100000)
    {
