...
static ssize_t MyDPVRconfig_proc_write(struct file *file, const char __user *buf,
	size_t count, loff_t *ppos)
{
       ...
       if (strncmp(num, "0", 1) == 0) {
		...
		printk("gMyDPVRconfig unknown data!!\n");
	}

       return count;
}
static const struct file_operations proc_gMyDPVRconfig_operations = {

       .write = MyDPVRconfig_proc_write,
};
...
//ASUS BSP wei lai +++
	...
	proc_create("MyDPVRconfig",  S_IWUSR, NULL,&proc_gMyDPVRconfig_operations);
//ASUS BSP wei lai ---
