#ifndef __a90_evb_GPIO_PINMUX_H
#define __a90_evb_GPIO_PINMUX_H

#include "a91_gpio_pinmux_setting.h"

#define KS8851_IRQ_GPIO 94

static struct msm_gpiomux_config a90_evb_msm8974_gpio_configs[] = {
...
//--- ASUS BSP Bernard: MyDP I2C
	...
	{
		// ASUS_BSP +++ Jiunhau_Wang GYRO interrupt pin = 20
		.gpio = 20, /* CCI_I2C_SCL0 */
		.settings = {
			[GPIOMUX_ACTIVE]    = &I_NP_cfg,     //unused
