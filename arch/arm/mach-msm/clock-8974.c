...
static struct clk_freq_tbl ftbl_gcc_gp_clk[] = {
	...
	F( 9600000,   cxo,  2,  0,   0),
	F(12000000,  gpll0,  10,   1,   5), //ASUS_BSP: Darrency_lin ++ camera mini porting
...
static struct clk_lookup msm_clocks_8974pro_only[] __initdata = {
	...
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "3c.qcom,camera"), //ASUS_BSP: Darrency_lin ++ camera mini porting
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "4-003c"), //ASUS_BSP: Darrency_lin ++ camera mini porting
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6a.qcom,camera"), //ASUS_BSP: Darrency_lin ++ camera mini porting
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "4-006a"), //ASUS_BSP: Darrency_lin ++ camera mini porting
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "6c.qcom,camera"),
	CLK_LOOKUP("cam_src_clk", mclk1_clk_src.c, "90.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk1_clk.c, "90.qcom,camera"),
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "3c.qcom,camera"), //ASUS_BSP: Darrency_lin ++ camera mini porting
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "4-003c"), //ASUS_BSP: Darrency_lin ++ camera mini porting
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "6a.qcom,camera"), //ASUS_BSP: Darrency_lin ++ camera mini porting
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "4-006a"), //ASUS_BSP: Darrency_lin ++ camera mini porting
...
static struct clk_lookup msm_clocks_8974_common[] __initdata = {
	...
	CLK_LOOKUP("iface_clk", gcc_blsp1_ahb_clk.c, "f9923000.i2c"),			//ASUS_BSP : Wireless Charger IC
	...
	CLK_LOOKUP("core_clk", gcc_blsp1_qup1_i2c_apps_clk.c, "f9923000.i2c"),//ASUS_BSP : Wireless Charger IC
	...
	CLK_LOOKUP("core_clk", gcc_gp1_clk.c, "4-003c"), //ASUS_BSP: Darrency_lin ++ camera mini porting
	CLK_LOOKUP("core_clk", gcc_gp1_clk.c, "3c.qcom,camera"), //ASUS_BSP: Darrency_lin ++ camera mini porting
	CLK_LOOKUP("core_clk", gcc_gp1_clk.c, "4-006a"), //ASUS_BSP: Darrency_lin ++ camera mini porting
	CLK_LOOKUP("core_clk", gcc_gp1_clk.c, "6a.qcom,camera"), //ASUS_BSP: Darrency_lin ++ camera mini porting
