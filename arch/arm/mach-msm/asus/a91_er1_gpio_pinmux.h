#ifndef __a91_er1_GPIO_PINMUX_H
#define __a91_er1_GPIO_PINMUX_H

#include "a91_gpio_pinmux_setting.h"

#define KS8851_IRQ_GPIO 94

static struct msm_gpiomux_config a91_er1_msm8974_gpio_configs[] = {
	...
	},
	{
		...
		.gpio = 8,
		.settings = {
			[GPIOMUX_SUSPENDED] = &I_PD_cfg, //A91_SR5,ER null pin
			[GPIOMUX_ACTIVE]    = &I_PD_cfg,	//A91_SR5,ER null pin
		},
	},
#if 0 	
...
//--- ASUS BSP Bernard: MyDP I2C
	...
	},
	{
		.gpio = 15, 
		.settings = {
			[GPIOMUX_ACTIVE]    = &I_PD_cfg, //A91_SR5_ER_null_pin
			[GPIOMUX_SUSPENDED] =&I_PD_cfg, //A91_SR5_ER_null_pin
		},
	},
	{
		.gpio = 16, 
...
//--- ASUS BSP Bernard: for mydp, cable detect 	
	{
		...
		.settings = {
			...
			[GPIOMUX_SUSPENDED] = &sd_card_det_active_config,
		},
	},
	{
		.gpio	= 63,		/* SYS_RST_N */
		.settings = {
			[GPIOMUX_ACTIVE] = &taiko_reset,
...
//ASUS BSP freddy++ vibrator gpio_rst pin
	{
		.gpio      = 81,		
		.settings = {
			[GPIOMUX_SUSPENDED] = &vibrator_gpio_rst_cfg,
			[GPIOMUX_ACTIVE] =  &vibrator_gpio_rst_cfg,
		},
	},
//ASUS BSP freddy++ vibrator gpio_rst pin
...
//--- ASUS_BSP Bernard: USB_HS_ID
	{
		...
		.settings = {
			[GPIOMUX_SUSPENDED] = &I_PD_cfg, //A91_SR5_ER_null_pin
			[GPIOMUX_ACTIVE] =  &I_PD_cfg, //A91_SR5_ER_null_pins
		},
	},	
	//ASUS_BSP +++ LiJen "[A86][Camera][NA][Others]Camera mini porting"
	{
