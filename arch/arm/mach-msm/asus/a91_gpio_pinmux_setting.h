#ifndef __A91_GPIO_SETTING_PINMUX_H
#define __A91_GPIO_SETTING_PINMUX_H

#include <linux/kernel.h>
#include <linux/gpio.h>
#include <mach/gpiomux.h>

#if 0//defined(CONFIG_KS8851) || defined(CONFIG_KS8851_MODULE)
...
static struct gpiomux_setting I_PD_cfg = {
    .func = GPIOMUX_FUNC_GPIO,
    .drv = GPIOMUX_DRV_2MA,
    .pull = GPIOMUX_PULL_DOWN ,
    .dir = GPIOMUX_IN,
...
static struct gpiomux_setting vibrator_gpio_rst_cfg = {
    .func = GPIOMUX_FUNC_GPIO,
    .drv = GPIOMUX_DRV_2MA,
    .pull = GPIOMUX_PULL_NONE,
    .dir = GPIOMUX_OUT_LOW,
...
//ASUS BSP freddy--
#endif  /* __A91_GPIO_PINMUX_SETTING_H  */
