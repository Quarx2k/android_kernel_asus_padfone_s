...
//extern struct bms_battery_data ASUS_A86_2320mAh_data;//Eason add A86 Bat data
extern struct bms_battery_data ASUS_A91_2215mAh_data;//Eason add A91 Bat data
